...
ticketPriceTotal = runners.map(runner => runner.donation).reduce((totalDonation, initDonation) => totalDonation + initDonation);
...
// Problem 3
// The event director wants to see each company and their respective donation.
let bizDonation = []
runners.forEach(runner => bizDonation.push(`${runner.company_name} donated $${runner.donation}`))
console.log(bizDonation);